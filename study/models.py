...
class GeneralInformation(models.Model):
    name = models.CharField(TherapeuticArea, max_length=100, null=True, blank=True)
    # slug = models.SlugField(max_length=200, db_index=True, unique=True)
    decease_name = models.ForeignKey(Disease, blank=True, null=True, verbose_name=_('decease_name'))
    protocol_title = models.CharField(_('protocol title'), max_length=200, null=True, blank=True, unique=True)
    ...
    phase = models.CharField(_('phase'), max_length=10, choices=PHASE_CHOICES, null=True, blank=True)
    ...
    study_type = models.CharField(_('study type'), max_length=10, choices=STUDY_TYPE_CHOICES, null=True, blank=True)
    ...
    study_design = models.CharField(_('study design'), max_length=10, choices=STUDY_DESIGN_CHOICES, null=True,
                                    blank=True)
...
class StudyIdentifiers(models.Model):
    ...
    sponsor_card = models.ForeignKey(Sponsor, verbose_name=_('sponsor'), null=True, blank=True)
    ...
    estimated_enrollment_company = models.IntegerField(_('Estimated enrollment in Ukraine according to "Company"'),
                                                       blank=True, null=True)
    enrollment_start_date_ukraine = models.DateTimeField(_('start date of enrolling patients in Ukraine'), blank=True, null=True)
...
class Materials(models.Model):
    ...
    study_related_materials = models.ForeignKey(StudyRelatedMaterials, verbose_name=_('study related materials'), null=True, blank=True)
...
class Eligibility(models.Model):
    ...
    inclusion_criteria = models.ForeignKey(InclusionCriteria, verbose_name=_('inclusion criteria'), null=True, blank=True)
    exclusion_criteria = models.ForeignKey(ExclusionCriteria, verbose_name=_('exclusion criteria'), null=True, blank=True)
...
class PrincipalInvestigator(models.Model):
    ...
    position = models.CharField(_('position'), max_length=20, choices=POSITION_CHOICES, null=True, blank=True)
...
class PlaceAddress(models.Model):
    ...
    settle_type = models.CharField(_('inhabited locality'), max_length=10, choices=ADDRESS_CHOICES_I, null=True, blank=True)
    STR = _('Street')
    SQR = _('Square')
    BLVD = _('Boulevard')
    LANE = _('Lane')
...
class MedicalInstitutionPhoneNumber(models.Model):
    ...
    receptions_ward = models.CharField(_('reception ward'), max_length=20, null=True, blank=True)  # приймальне відділення
...
class Place(models.Model):
    ...
    principal_investigator = models.ForeignKey(PrincipalInvestigator, verbose_name=_('principal investigator'),  null=True, blank=True)
    principal_investigator_phone_number = models.CharField(_('principal investigator phone number'), max_length=20, null=True, blank=True)
    medical_institution = models.CharField(_('medical institution'), max_length=100, null=True, blank=True)
    medical_institution_department = models.CharField(_('medical institution department'), max_length=100, null=True, blank=True)
    ...
    medical_institution_department_phone_number = models.CharField(_('medical institution department phone number'), max_length=20, null=True, blank=True)
    medical_institution_department_fax = models.CharField(_('medical institution department fax'), max_length=20, null=True, blank=True)
    medical_educational_institution = models.CharField(_('medical educational institution'), max_length=100, null=True, blank=True)
    medical_educational_institution_department = models.CharField(_('medical educational institution department'), max_length=100, null=True, blank=True)
    medical_institution_contact_person_name = models.CharField(_('medical institution contact person name'), max_length=100, null=True, blank=True)
    company_contact_person_name = models.CharField(_('company contact person name'), max_length=100, null=True, blank=True)
    contact_person_phone_number = models.CharField(_('conact person phone number'), max_length=20, null=True, blank=True)
    contact_person_fax = models.CharField(_('conact person fax'), max_length=20, null=True, blank=True)
    contact_person_email = models.CharField(_('conact person email'), max_length=100, null=True, blank=True)
